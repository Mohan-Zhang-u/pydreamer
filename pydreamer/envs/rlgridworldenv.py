...
class RLGridWorldEnv(gym.Env):
    ...
    def __init__(self, name, action_repeat=1, size=(64, 64)):
        ...
        env = GridEnv(load_chars_rep_fromd_dir='RLGridWorldSettings/FourTargets.txt', render_mode='human', obs_mode='single_rgb_array', render_width=size[0], render_height=size[1])
        self.env = env
